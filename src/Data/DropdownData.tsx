...
const appointmentReasons = ["General Consultation", "Follow-up", "Prescription Refill", "Lab Test Results", "Specialist Referral", "Vaccination", "Health Screening", "Chronic Condition Management", "Mental Health Support", "Physical Therapy", "Surgical Consultation", "Emergency Care"];
export { bloodGroups, bloodGroupMap, doctorSpecializations, doctorDepartments, appointmentReasons };