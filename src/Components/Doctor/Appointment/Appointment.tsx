...
import { cancelAppointment, getAppointmentsByDoctor, scheduleAppointment } from '../../../Service/AppointmentService.tsx';
    ...
    return (
        <div className="card">
            ...
            <DataTable stripedRows value={filterAppointmentsByTab} size='small' paginator rows={10}
                ...
                rowsPerPageOptions={[10, 25, 50]} dataKey="id" filters={filters} filterDisplay="menu" globalFilterFields={['patientName', 'reason', 'notes', 'status']}
                ...
                <Column field="patientPhone" header="Phone" sortable style={{ minWidth: '14rem' }} />
