...
import { Avatar, Group, Text, TextInput, Badge, Card } from '@mantine/core';
...
const PatientList: React.FC = () => {
        ...
        return (
            <div className="min-h-[56px] flex items-center">
                <Group gap="sm" wrap="nowrap">
                    <Avatar radius="xl" size={40} color="blue" variant="light">
                        {initials}
                    </Avatar>
    ...
    const header = (
        <Group justify="space-between" mb="md">
            <div>
                <Text fw={600} size="xl" className="text-primary-600">Patient Registry</Text>
                <Text size="xs" color="dimmed">Full patient directory with medical summary</Text>
            </div>
            <TextInput
                value={globalFilter}
